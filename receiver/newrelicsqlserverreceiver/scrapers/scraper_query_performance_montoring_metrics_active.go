...
func (s *QueryPerformanceScraper) processLockedObjectMetrics(result models.LockedObject, index int) error {
	...
	s.mb.RecordSqlserverLockedObjectDataPoint(timestamp, 1)
