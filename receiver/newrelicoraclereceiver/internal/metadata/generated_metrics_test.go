...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			defaultMetricsCount++
			allMetricsCount++
			mb.RecordNewrelicoracledbIndividualQueriesCPUTimeDataPoint(ts, 1, "newrelic.entity_name-val", "query_id-val", "sid-val", "serial_number-val", "username-val", "session_status-val", "plan_hash_value-val", "os_user-val", "hostname-val")

			defaultMetricsCount++
			allMetricsCount++
			mb.RecordNewrelicoracledbIndividualQueriesElapsedTimeDataPoint(ts, 1, "newrelic.entity_name-val", "query_id-val", "sid-val", "serial_number-val", "username-val", "session_status-val", "plan_hash_value-val", "os_user-val", "hostname-val")

			defaultMetricsCount++
			allMetricsCount++
			mb.RecordNewrelicoracledbIndividualQueriesQueryDetailsDataPoint(ts, 1, "newrelic.entity_name-val", "query_id-val", "sid-val", "serial_number-val", "username-val", "session_status-val", "plan_hash_value-val", "os_user-val", "hostname-val", "query_text-val")
			...
			for i := 0; i < ms.Len(); i++ {
				...
				case "newrelicoracledb.individual_queries.cpu_time":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
					assert.Equal(t, "CPU time for individual active queries", ms.At(i).Description())
					assert.Equal(t, "ms", ms.At(i).Unit())
					dp := ms.At(i).Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					...
					assert.True(t, ok)
					assert.Equal(t, "sid-val", attrVal.Str())
					attrVal, ok = dp.Attributes().Get("serial_number")
					assert.True(t, ok)
					assert.Equal(t, "serial_number-val", attrVal.Str())
					...
					attrVal, ok = dp.Attributes().Get("os_user")
					assert.True(t, ok)
					assert.Equal(t, "os_user-val", attrVal.Str())
				...
				case "newrelicoracledb.individual_queries.elapsed_time":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
					assert.Equal(t, "Elapsed time for individual active queries", ms.At(i).Description())
					assert.Equal(t, "ms", ms.At(i).Unit())
					dp := ms.At(i).Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
