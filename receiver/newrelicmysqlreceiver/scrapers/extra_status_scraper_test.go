...
func TestNewExtraStatusScraper(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			scraper, err := NewExtraStatusScraper(tt.client, tt.mb, tt.logger)
...
func TestExtraStatusScraper_ScrapeMetrics_Success(t *testing.T) {
	...
	mockClient.GlobalStats = map[string]string{
...
func TestExtraStatusScraper_ScrapeMetrics_ClientError(t *testing.T) {
	mockClient := common.NewMockClient()
	mockClient.GlobalStatsErr = errors.New("database connection error")
