...
func NewFailoverClusterScraper(conn SQLConnectionInterface, logger *zap.Logger, engineEdition int, mb *metadata.MetricsBuilder) *FailoverClusterScraper {
...
// processFailoverClusterReplicaMetrics processes replica metrics using MetricsBuilder
func (s *FailoverClusterScraper) processFailoverClusterReplicaMetrics(result models.FailoverClusterReplicaMetrics) error {
	// Failover cluster replica metrics are not currently defined in metadata.yaml
	// This method is kept for future extensibility
	return nil
}

// processFailoverClusterReplicaStateMetrics processes replica state metrics using MetricsBuilder
func (s *FailoverClusterScraper) processFailoverClusterReplicaStateMetrics(result models.FailoverClusterReplicaStateMetrics) error {
	// Failover cluster replica state metrics are not currently defined in metadata.yaml
	// This method is kept for future extensibility
	return nil
}
...
// processFailoverClusterAvailabilityGroupHealthMetrics processes availability group health metrics using MetricsBuilder
func (s *FailoverClusterScraper) processFailoverClusterAvailabilityGroupHealthMetrics(result models.FailoverClusterAvailabilityGroupHealthMetrics) error {
	// Failover cluster health metrics not yet defined in metadata.yaml
	return nil
}
...
// processFailoverClusterAvailabilityGroupMetrics processes availability group configuration metrics using MetricsBuilder
...
// processFailoverClusterRedoQueueMetrics processes redo queue metrics using MetricsBuilder
func (s *FailoverClusterScraper) processFailoverClusterRedoQueueMetrics(result models.FailoverClusterRedoQueueMetrics) error {
	// Failover cluster redo queue metrics not yet defined in metadata.yaml
	return nil
}
