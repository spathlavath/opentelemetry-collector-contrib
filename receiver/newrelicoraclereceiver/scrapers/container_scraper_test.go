...
func TestNewContainerScraper_ValidInputs(t *testing.T) {
	...
	scraper, err := NewContainerScraper(mockClient, mb, logger, "test-instance", config)
...
func TestNewContainerScraper_NilClient(t *testing.T) {
	...
	scraper, err := NewContainerScraper(nil, mb, logger, "test-instance", config)
...
func TestNewContainerScraper_NilMetricsBuilder(t *testing.T) {
	...
	scraper, err := NewContainerScraper(mockClient, nil, logger, "test-instance", config)
...
func TestNewContainerScraper_NilLogger(t *testing.T) {
	...
	scraper, err := NewContainerScraper(mockClient, mb, nil, "test-instance", config)
...
func TestNewContainerScraper_EmptyInstanceName(t *testing.T) {
	...
	scraper, err := NewContainerScraper(mockClient, mb, logger, "", config)
