...
// DeadlockCount represents the cumulative count of deadlocks
type DeadlockCount struct {
	DeadlockCount sql.NullInt64
}

// GetCount returns the deadlock count, 0 if null
func (dc *DeadlockCount) GetCount() int64 {
	if dc.DeadlockCount.Valid {
		return dc.DeadlockCount.Int64
	}
	return 0
}
