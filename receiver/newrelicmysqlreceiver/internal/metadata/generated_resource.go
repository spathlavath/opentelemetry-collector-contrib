...
// SetMysqlInstanceVersion sets provided value as "mysql.instance.version" attribute.
func (rb *ResourceBuilder) SetMysqlInstanceVersion(val string) {
	if rb.config.MysqlInstanceVersion.Enabled {
		rb.res.Attributes().PutStr("mysql.instance.version", val)
	}
}
